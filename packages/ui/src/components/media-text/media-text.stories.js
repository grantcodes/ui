...
export const Default = {
	args: {
		...
		media: JSON.stringify({ src: "https://placehold.co/640x480", alt: "Design tokens diagram", kind: "image" }),
...
export const Reversed = {
	args: {
		...
		media: JSON.stringify({ src: "https://placehold.co/640x480", alt: "Accessibility diagram", kind: "image" }),
		reverse: true,
	},
};
...
export const Video = {
	args: {
		...
		media: JSON.stringify({ src: "https://www.w3schools.com/html/mov_bbb.mp4", alt: "Demo video", kind: "video" }),
